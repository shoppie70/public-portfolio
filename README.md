...
- ReactおよびReact Nativeを用いたWebアプリケーション・クロスプラットフォームモバイルアプリ開発を実務で経験。顧客と打ち合わせを重ねながら、1人で開発からリリースまで一貫して行いました。
- Reactを用いたSPA（シングルページアプリケーション）のWebアプリのリリース実績が豊富で、モバイル端末向けのアプリ構築まで幅広く対応可能です。
